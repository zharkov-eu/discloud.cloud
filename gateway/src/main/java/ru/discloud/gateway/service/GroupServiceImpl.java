...
public class GroupServiceImpl implements GroupService {
  ...
  @Override
  public Mono<Group> updateGroup(Integer id, GroupRequest request) throws JsonProcessingException {
    return fileStore.request("PATCH", "/group/" + id, null, mapper.writeValueAsString(request))
        .doOnSuccess(response -> AuthRequestService.checkServiceResponse(ServiceEnum.FILE, response))
        .map(this::mapResponseToGroup);
  }
